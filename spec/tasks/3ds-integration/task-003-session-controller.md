...
links:
  ...
  - spec/tasks/3ds-integration/task-002-session-request-dtos-and-create-session.md
---
...
- **Local dependencies:**
  - `ThreeDsSessionRequest`, `ThreeDsSessionResponse` records (from task-002)
  - `ChallengeSessionService.createSession` (from task-002)
