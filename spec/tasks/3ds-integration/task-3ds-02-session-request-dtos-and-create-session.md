...
links:
  ...
  - spec/tasks/3ds-integration/task-3ds-01-jwt-generate-token.md
---
...
- **Local dependencies:**
  - `JwtTokenProvider.generateToken` (from task-3ds-01)
...
- Do NOT put UUID generation, URL building, or JWT signing in the controller (task-3ds-03) — all of it lives in this service
