...
- spec-007-merchant-dashboard.md — merchant-facing transaction dashboard: API key auth, transaction list with filters and auto-refresh, detail view, status badges, webhook delivery status; extended: sidebar nav, analytics, reconciliation, webhooks log, settings
